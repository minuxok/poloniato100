...
const resources = {
  it: {
    translation: {
      ...
      nfc_denied: 'Lettura NFC non consentita. Abilitala nelle impostazioni del browser, poi avvicina di nuovo il telefono all\'icona NFC <nfc/> dell\'opera.',
  ...
  en: {
    translation: {
      ...
      nfc_denied: 'NFC reading is blocked. Allow it in your browser settings, then hold your phone near the artwork\'s NFC icon <nfc/> again.',
  ...
  fr: {
    translation: {
      ...
      nfc_denied: 'Lecture NFC bloquée. Autorisez-la dans les réglages du navigateur, puis rapprochez le téléphone de l\'icône NFC <nfc/> de l\'œuvre.',
  ...
  es: {
    translation: {
      ...
      nfc_denied: 'Lectura NFC no permitida. Actívala en la configuración del navegador y acerca de nuevo el teléfono al icono NFC <nfc/> de la obra.',
  ...
  de: {
    translation: {
      ...
      nfc_denied: 'NFC-Lesung ist blockiert. Erlauben Sie sie in den Browsereinstellungen und halten Sie das Telefon erneut an das NFC-Symbol <nfc/> des Kunstwerks.',
